...
const _perfectWife = AnimalSynergy(animal: Animal.Horse, flavor: Energy.EarthYin);
const _perfectHusband = AnimalSynergy(animal: Animal.Dog, flavor: Energy.FireYin);
...
bool isBadWife(AnimalSynergy day) {
  ...
  if (contained.animal != _perfectWife.animal && contained.flavor != _perfectWife.flavor) {
    return true;
  }
  return false;
}
...
bool isBadHusband(AnimalSynergy day) {
  ...
  if (contained.animal != _perfectHusband.animal && contained.flavor != _perfectHusband.flavor) {
    return true;
  }
  return false;
}
...
const femaleWealthAbsorbing = <AnimalSynergy>[
...
const femaleWealthAbsorbed = <AnimalSynergy>[
